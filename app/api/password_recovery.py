...
# Importar la función para limpiar el contador de intentos desde login_local
from app.api.login_local import clear_rate_limit 
...
async def reset_password(
    ...
    try:
        ...
        # --- CORRECCIÓN CLAVE: Limpiar el contador de intentos de login ---
        clear_rate_limit(redis_client, data.email)
        print(f"DEBUG: Login attempt counter for {data.email} has been reset.")
